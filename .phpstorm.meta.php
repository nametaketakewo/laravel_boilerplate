...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'auth.guards.tenant.driver' => 'string',
            'auth.guards.tenant.provider' => 'string',
            ...
            'auth.providers.tenant_users.driver' => 'string',
            'auth.providers.tenant_users.model' => 'string',
            ...
            'database.connections.pgsql.read.host' => 'string',
            'database.connections.pgsql.read.port' => 'string',
            'database.connections.pgsql.write.host' => 'string',
            'database.connections.pgsql.write.port' => 'string',
            ...
            'filesystems.links./Users/nametaketakewo/Clients/nametaketakewo/laravel_boilerplate/public/storage' => 'string',
...
'auth.guards.tenant.driver','auth.guards.tenant.provider','auth.guards.sanctum.driver','auth.guards.sanctum.provider','auth.providers.users.driver',
'auth.providers.users.model','auth.providers.tenant_users.driver','auth.providers.tenant_users.model','auth.passwords.users.provider','auth.passwords.users.table',
...
'database.connections.mariadb.options','database.connections.pgsql.driver','database.connections.pgsql.url','database.connections.pgsql.read.host','database.connections.pgsql.read.port',
'database.connections.pgsql.write.host','database.connections.pgsql.write.port','database.connections.pgsql.sticky','database.connections.pgsql.database','database.connections.pgsql.username',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./Users/nametaketakewo/Clients/nametaketakewo/laravel_boilerplate/public/storage','inertia.ssr.enabled','inertia.ssr.url',
...
'cors.allowed_headers','cors.exposed_headers','cors.max_age','cors.supports_credentials','pennant.default',
'pennant.stores.array.driver','pennant.stores.database.driver','pennant.stores.database.connection','pennant.stores.database.table','sanctum.stateful',
...
'dusk.login','dusk.logout','dusk.user','sanctum.csrf-cookie','dashboard','profile.edit','profile.update','profile.destroy',
'todos.index','todos.store','todos.update','todos.destroy','register','login','password.request','password.email',
...
'PORT_PREFIX','APP_NAME','APP_ENV','APP_KEY','APP_DEBUG',
...
'AWS_ENDPOINT','AWS_URL','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME',);
